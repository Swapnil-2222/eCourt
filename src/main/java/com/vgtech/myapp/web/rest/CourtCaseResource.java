...
/**
 * REST controller for managing {@link com.vgtech.myapp.domain.CourtCase}.
 */
@RestController
@RequestMapping("/api")
public class CourtCaseResource {
    ...
    public ResponseEntity<List<CourtCaseDTO>> getAllCourtCases(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
