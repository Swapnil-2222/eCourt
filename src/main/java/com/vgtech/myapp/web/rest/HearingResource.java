...
import com.vgtech.myapp.repository.HearingRepository;
import com.vgtech.myapp.service.HearingService;
...
/**
 * REST controller for managing {@link com.vgtech.myapp.domain.Hearing}.
 */
@RestController
@RequestMapping("/api")
public class HearingResource {
     ...
     */
    @GetMapping("/hearings")
    public ResponseEntity<List<HearingDTO>> getAllHearings(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
