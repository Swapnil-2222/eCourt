package com.vgtech.myapp.web.rest;
...
import com.vgtech.myapp.IntegrationTest;
...
class CourtCaseResourceIT {
    ...
    private static final String DEFAULT_RELATED_CLAUSES = "AAAAAAAAAA";
    private static final String UPDATED_RELATED_CLAUSES = "BBBBBBBBBB";

    private static final String DEFAULT_SECTION_4_NOTIFICATION_DATE = "AAAAAAAAAA";
    private static final String UPDATED_SECTION_4_NOTIFICATION_DATE = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_DEFEDANT_LAWYER = "AAAAAAAAAA";
    private static final String UPDATED_DEFEDANT_LAWYER = "BBBBBBBBBB";

    private static final String DEFAULT_NATURE_RESULT = "AAAAAAAAAA";
    private static final String UPDATED_NATURE_RESULT = "BBBBBBBBBB";

    private static final String DEFAULT_APPLICATION_NO_FILE_ADDITIONAL_INTEREST = "AAAAAAAAAA";
    private static final String UPDATED_APPLICATION_NO_FILE_ADDITIONAL_INTEREST = "BBBBBBBBBB";

    private static final String DEFAULT_CURRENT_APPLICATION_STATUS = "AAAAAAAAAA";
    private static final String UPDATED_CURRENT_APPLICATION_STATUS = "BBBBBBBBBB";

    private static final String DEFAULT_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT = "AAAAAAAAAA";
    private static final String UPDATED_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT = "BBBBBBBBBB";

    private static final String DEFAULT_CURRENT_CASE_STATUS = "AAAAAAAAAA";
    private static final String UPDATED_CURRENT_CASE_STATUS = "BBBBBBBBBB";

    private static final String DEFAULT_BANK_GUARANTEE_DETAIL_APPLICATION_NO = "AAAAAAAAAA";
    private static final String UPDATED_BANK_GUARANTEE_DETAIL_APPLICATION_NO = "BBBBBBBBBB";
    ...
    public static CourtCase createEntity(EntityManager em) {
        CourtCase courtCase = new CourtCase()
            ...
            .relatedClauses(DEFAULT_RELATED_CLAUSES)
            .section4NotificationDate(DEFAULT_SECTION_4_NOTIFICATION_DATE)
            .judgementDate(DEFAULT_JUDGEMENT_DATE)
            .accuserLawyer(DEFAULT_ACCUSER_LAWYER)
            .defedantLawyer(DEFAULT_DEFEDANT_LAWYER)
            .natureResult(DEFAULT_NATURE_RESULT)
            .applicationNoFileAdditionalInterest(DEFAULT_APPLICATION_NO_FILE_ADDITIONAL_INTEREST)
            .currentApplicationStatus(DEFAULT_CURRENT_APPLICATION_STATUS)
            .amountAdditionalInterestdefendantDistrictCourt(DEFAULT_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT)
            .currentCaseStatus(DEFAULT_CURRENT_CASE_STATUS)
            .bankGuaranteeDetailApplicationNo(DEFAULT_BANK_GUARANTEE_DETAIL_APPLICATION_NO);
        return courtCase;
    }
    ...
    public static CourtCase createUpdatedEntity(EntityManager em) {
        CourtCase courtCase = new CourtCase()
            ...
            .relatedClauses(UPDATED_RELATED_CLAUSES)
            .section4NotificationDate(UPDATED_SECTION_4_NOTIFICATION_DATE)
            .judgementDate(UPDATED_JUDGEMENT_DATE)
            .accuserLawyer(UPDATED_ACCUSER_LAWYER)
            .defedantLawyer(UPDATED_DEFEDANT_LAWYER)
            .natureResult(UPDATED_NATURE_RESULT)
            .applicationNoFileAdditionalInterest(UPDATED_APPLICATION_NO_FILE_ADDITIONAL_INTEREST)
            .currentApplicationStatus(UPDATED_CURRENT_APPLICATION_STATUS)
            .amountAdditionalInterestdefendantDistrictCourt(UPDATED_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT)
            .currentCaseStatus(UPDATED_CURRENT_CASE_STATUS)
            .bankGuaranteeDetailApplicationNo(UPDATED_BANK_GUARANTEE_DETAIL_APPLICATION_NO);
        return courtCase;
    }
    ...
    void createCourtCase() throws Exception {
        ...
        assertThat(testCourtCase.getRelatedClauses()).isEqualTo(DEFAULT_RELATED_CLAUSES);
        assertThat(testCourtCase.getSection4NotificationDate()).isEqualTo(DEFAULT_SECTION_4_NOTIFICATION_DATE);
        ...
        assertThat(testCourtCase.getDefedantLawyer()).isEqualTo(DEFAULT_DEFEDANT_LAWYER);
        assertThat(testCourtCase.getNatureResult()).isEqualTo(DEFAULT_NATURE_RESULT);
        assertThat(testCourtCase.getApplicationNoFileAdditionalInterest()).isEqualTo(DEFAULT_APPLICATION_NO_FILE_ADDITIONAL_INTEREST);
        assertThat(testCourtCase.getCurrentApplicationStatus()).isEqualTo(DEFAULT_CURRENT_APPLICATION_STATUS);
        assertThat(testCourtCase.getAmountAdditionalInterestdefendantDistrictCourt())
            .isEqualTo(DEFAULT_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT);
        assertThat(testCourtCase.getCurrentCaseStatus()).isEqualTo(DEFAULT_CURRENT_CASE_STATUS);
        assertThat(testCourtCase.getBankGuaranteeDetailApplicationNo()).isEqualTo(DEFAULT_BANK_GUARANTEE_DETAIL_APPLICATION_NO);
    }
    ...
    void getAllCourtCases() throws Exception {
        ...
        restCourtCaseMockMvc
            ...
            .andExpect(jsonPath("$.[*].relatedClauses").value(hasItem(DEFAULT_RELATED_CLAUSES)))
            .andExpect(jsonPath("$.[*].section4NotificationDate").value(hasItem(DEFAULT_SECTION_4_NOTIFICATION_DATE)))
            ...
            .andExpect(jsonPath("$.[*].defedantLawyer").value(hasItem(DEFAULT_DEFEDANT_LAWYER)))
            .andExpect(jsonPath("$.[*].natureResult").value(hasItem(DEFAULT_NATURE_RESULT)))
            .andExpect(
                jsonPath("$.[*].applicationNoFileAdditionalInterest").value(hasItem(DEFAULT_APPLICATION_NO_FILE_ADDITIONAL_INTEREST))
            )
            .andExpect(jsonPath("$.[*].currentApplicationStatus").value(hasItem(DEFAULT_CURRENT_APPLICATION_STATUS)))
            .andExpect(
                jsonPath("$.[*].amountAdditionalInterestdefendantDistrictCourt")
                    .value(hasItem(DEFAULT_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT))
            )
            .andExpect(jsonPath("$.[*].currentCaseStatus").value(hasItem(DEFAULT_CURRENT_CASE_STATUS)))
            .andExpect(jsonPath("$.[*].bankGuaranteeDetailApplicationNo").value(hasItem(DEFAULT_BANK_GUARANTEE_DETAIL_APPLICATION_NO)));
    }
    ...
    void getCourtCase() throws Exception {
        ...
        restCourtCaseMockMvc
            ...
            .andExpect(jsonPath("$.relatedClauses").value(DEFAULT_RELATED_CLAUSES))
            .andExpect(jsonPath("$.section4NotificationDate").value(DEFAULT_SECTION_4_NOTIFICATION_DATE))
            ...
            .andExpect(jsonPath("$.defedantLawyer").value(DEFAULT_DEFEDANT_LAWYER))
            .andExpect(jsonPath("$.natureResult").value(DEFAULT_NATURE_RESULT))
            .andExpect(jsonPath("$.applicationNoFileAdditionalInterest").value(DEFAULT_APPLICATION_NO_FILE_ADDITIONAL_INTEREST))
            .andExpect(jsonPath("$.currentApplicationStatus").value(DEFAULT_CURRENT_APPLICATION_STATUS))
            .andExpect(
                jsonPath("$.amountAdditionalInterestdefendantDistrictCourt")
                    .value(DEFAULT_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT)
            )
            .andExpect(jsonPath("$.currentCaseStatus").value(DEFAULT_CURRENT_CASE_STATUS))
            .andExpect(jsonPath("$.bankGuaranteeDetailApplicationNo").value(DEFAULT_BANK_GUARANTEE_DETAIL_APPLICATION_NO));
    }
    ...
    void putNewCourtCase() throws Exception {
        ...
        assertThat(testCourtCase.getRelatedClauses()).isEqualTo(UPDATED_RELATED_CLAUSES);
        assertThat(testCourtCase.getSection4NotificationDate()).isEqualTo(UPDATED_SECTION_4_NOTIFICATION_DATE);
        ...
        assertThat(testCourtCase.getDefedantLawyer()).isEqualTo(UPDATED_DEFEDANT_LAWYER);
        assertThat(testCourtCase.getNatureResult()).isEqualTo(UPDATED_NATURE_RESULT);
        assertThat(testCourtCase.getApplicationNoFileAdditionalInterest()).isEqualTo(UPDATED_APPLICATION_NO_FILE_ADDITIONAL_INTEREST);
        assertThat(testCourtCase.getCurrentApplicationStatus()).isEqualTo(UPDATED_CURRENT_APPLICATION_STATUS);
        assertThat(testCourtCase.getAmountAdditionalInterestdefendantDistrictCourt())
            .isEqualTo(UPDATED_AMOUNT_ADDITIONAL_INTERESTDEFENDANT_DISTRICT_COURT);
        assertThat(testCourtCase.getCurrentCaseStatus()).isEqualTo(UPDATED_CURRENT_CASE_STATUS);
        assertThat(testCourtCase.getBankGuaranteeDetailApplicationNo()).isEqualTo(UPDATED_BANK_GUARANTEE_DETAIL_APPLICATION_NO);
    }
